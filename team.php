    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center pb-2">
                <h1 class="mb-4">Shërbimet </h1>
                <h6 class="text-uppercase">Shërbimet e Shoqërisë GMK Auditing Shpk ofrohen për të gjitha llojet e
                    bizneseve nga
                    një staf specialistësh</h6>
            </div>
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="owl-carousel team-carousel position-relative"
                        ...
                        <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                            <h5 class="mb-2 px-4">Kurse</h5>
                            <p class="mb-3 px-4">Kurse trajnimi dhe formimi profesional</p>
                            <div class="team-img position-relative">
                                <img class="img-fluid" src="img/sherbimet1.jpg" alt="">
                                <div class="team-social">
                                    <button class="btn btn-primary btn-block border-0 py-3" type="submit">See
                                        More</button>
                                </div>
                            </div>
                        </div>
                        <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                            ...
                            <p class="mb-3 px-4">Kurse trajnimi dhe formimi profesional</p>
                            <div class="team-img position-relative">
                                <img class="img-fluid" src="img/sherbimet2.jpg" alt="">
                                <div class="team-social">
                                    <button class="btn btn-primary btn-block border-0 py-3" type="submit">See
                                        More</button>
                                </div>
                        ...
                        <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                            ...
                            <p class="mb-3 px-4">Kurse trajnimi dhe formimi profesional</p>
                            <div class="team-img position-relative">
                                <img class="img-fluid" src="img/sherbimet3.jpg" alt="">
                                <div class="team-social">
                                    <button class="btn btn-primary btn-block border-0 py-3" type="submit">See
                                        More</button>
                                </div>
                        ...
                        <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                            ...
                            <p class="mb-3 px-4">Kurse trajnimi dhe formimi profesional</p>
                            <div class="team-img position-relative">
                                <img class="img-fluid" src="img/sherbimet4.jpg" alt="">
                                <div class="team-social">
                        ...
                        <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                            ...
                            <p class="mb-3 px-4">Kurse trajnimi dhe formimi profesional</p>
                            <div class="team-img position-relative">
                                <img class="img-fluid" src="img/sherbimet5.jpg" alt="">
                                <div class="team-social">
                                    <button class="btn btn-primary btn-block border-0 py-3" type="submit">See
                                        More</button>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100 rounded overflow-hidden">
                        <img class="position-absolute w-100 h-100" src="img/services.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="feature-text bg-white rounded p-lg-5">
                        <h6 class="text-uppercase">Cfare Ofrojme</h6>
                        <h1 class="mb-4">Sherbimet Shtese</h1>
                        <div class="d-flex mb-4">
                            ...
                            <div class="ml-4">
                                <h5>Ankimime</h5>
                                <p class="m-0">Ankimimi kundër vendimeve administrative të
                                    administratës tatimeve dhe doganës. Gjithashtu
                                    ankimime në Gjykatën Administrative.</p>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="btn-primary btn-lg-square px-3" style="border-radius: 50px;">
                            ...
                            <div class="ml-4">
                                <h5>Konsulenca</h5>
                                <p class="m-0">Konsulenca juridike</p>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="btn-primary btn-lg-square px-3" style="border-radius: 50px;">
                            ...
                            <div class="ml-4">
                                <h5>Plane biznesi </h5>
                                <p class="m-0">Pregatitje plan biznesi dhe dokumenta për kredi </p>
                            </div>
                        </div>
                        <div class="d-flex mt-4">
                            ...
                            <div class="ml-4">
                                <h5>Cmime favorizuese </h5>
                                <p class="m-0">Shërbimet (ankimime administrative ,konsulencë juridike ) kryhen nga
                                    juristja e zyrës kundrejtë tarifave 20% nën vlerën e tregu</p>
                            </div>
                        </div>
                    </div>
                </div>
