...
<head>
    <meta charset="utf-8">
    <title>Contact | GMK Auditing</title>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center pb-2">
                ...
                <h1 class="mb-4">Contact Us For Any Questions</h1>
            </div>
            <div class="container-fluid78 filter">
                    ...
                    <div class="container78">
                        <div class="card">
                            <div class="box">
                                <div class="content78">
                                    <h3>Kontakt</h3>
                                    <p>Mobile: +355 (0) 672020194<br>
                                        Faks<br>
                                        E-mail: info@gmkauditing.al
                                    </p>
                                    <a class="button77" href="#">Read More</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="box">
                                <div class="content78">
                                    <h3>Orari I Punes</h3>
                                    <p>Hene-Premte: 8:00-17:00 <br>
                                        Shtune: 9:00-13:00<br>
                                        Diele: Pushim
                                    </p>
                                    <a class="button77" href="#">Read More</a>
                                </div>
                        ...
                        <div class="card">
                            <div class="box">
                                <div class="content78">
                                    <h3>Adresa</h3>
                                    <p>Zyra: Rruga Don Bosko Kompleksi MEILD Tiranë, 1001 Shqipëri </p>
                                    <a class="button77" href="">Read More</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6" style="min-height: 400px;">
                    <div class="position-relative h-100 rounded overflow-hidden">
                        <iframe style="width: 100%; height: 100%; object-fit: cover;"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d508.1073262450389!2d19.805361088658763!3d41.33441222682755!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x135031ff37d7c34b%3A0x4ed1460abf5a56ba!2sAG%20Travel!5e0!3m2!1ssq!2s!4v1691662018510!5m2!1ssq!2s"
...
<style>
    ...
    .container78 .card:nth-child(1) .box .content78 a {
        background: #B49C73;
    }

    .container78 .card:nth-child(2) .box .content78 a {
        background: #B49C73;
    }

    .container78 .card:nth-child(3) .box .content78 a {
        background: #B49C73;
    }

    .container78 .card .box {
        position: absolute;
        top: 20px;
        left: 20px;
        right: 20px;
    ...
    .container78 .card .box:hover {
        transform: translateY(-50px);
    }

    .container78 .card .box:before {
        content: "";
        position: absolute;
        top: 0;
        left: 0;
    ...
    .container78 .card .box .content78 {
        padding: 20px;
        text-align: center;
    }

    .container78 .card .box .content78 h2 {
        position: absolute;
        top: -10px;
        right: 30px;
        font-size: 8rem;
    ...
    .container78 .card .box .content78 h3 {
        font-size: 1.8rem;
        color: #fff;
        z-index: 1;
        transition: 0.5s;
    ...
    .container78 .card .box .content78 p {
        font-size: 1rem;
        font-weight: 300;
    ...
    .container78 .card .box .content78 a {
        font-weight: 900;
        position: relative;
    ...
    .container78 .card .box .content78 a:hover {
