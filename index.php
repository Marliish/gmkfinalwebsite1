        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item position-relative active" style="height: 100vh; min-height: 400px;">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-4" style="letter-spacing: 3px;">Premier Accountant
                                Excellence
                            </h4>
                            <h3 class="display-2 text-capitalize text-white mb-4">
                                Balancing Success, Counting Excellence</h3>
                ...
                <div class="carousel-item position-relative" style="height: 100vh; min-height: 400px;">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-4" style="letter-spacing: 3px;">Achieving Your
                                Aspirations
                            </h4>
                            <h3 class="display-2 text-capitalize text-white mb-4">Numbers Elevated, Success Calculated
                            </h3>
                            <a class="btn btn-primary py-3 px-5 mt-2" href="#" id="callButton">Call Us Now</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-7 mt-4 mt-lg-0">
                    ...
                    <h1 class="mb-4">With a Rich Legacy of 25 Years, We Bring Unmatched Expertise to Every Accounting
                        Challenge.</h1>
                    <p>At GMK Auditing, we proudly celebrate a quarter-century of dedicated service and
                        unwavering commitment to excellence in the field of accounting. With each passing year, we have
                        honed our skills, refined our strategies, and accumulated a wealth of knowledge that sets us
                        apart.</p>
                ...
                <div class="col-lg-9 pt-5 pt-lg-0">
                    ...
                    <div class="owl-carousel service-carousel position-relative"
                        ...
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            ...
                            <h5 class="mb-4 px-4">Bookkeeping</h5>
                            <p class="m-0">Maintaining accurate and up-to-date financial records, including recording
                                transactions, reconciling accounts, and organizing financial data.</p>
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            <div class="icon-box bg-secondary text-primary mt-2 mb-4">
                                <i class="fa fa-2x fa-users"></i>
                            </div>
                            <h5 class="mb-4 px-4">Financial Statement Preparation</h5>
                            <p class="m-0">Creating financial statements such as balance sheets, income statements, and
                                cash flow statements to provide a clear picture of a business's financial health.</p>
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            <div class="icon-box bg-secondary text-primary mt-2 mb-4">
                                <i class="fa fa-2x fa-hand-holding-usd"></i>
                            </div>
                            <h5 class="mb-4 px-4">Tax Planning and Preparation</h5>
                            <p class="m-0">Advising clients on tax strategies to minimize tax liabilities, preparing and
                                filing tax returns, and ensuring compliance with tax laws and regulations</p>
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            <div class="icon-box bg-secondary text-primary mt-2 mb-4">
                                <i class="fa fa-2x fa-gavel"></i>
                            </div>
                            <h5 class="mb-4 px-4">Auditing and Assurance</h5>
                            <p class="m-0">Conducting audits, reviews, and compilations of financial statements to
                                ensure accuracy, transparency, and adherence to accounting standards</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 py-5">
                        <div class="rounded p-5 my-5" style="background: rgba(55, 55, 63, .7);">
                            ...
                            <form class="contact" method="post" id="contact-form">     
                                ...
                                <textarea name="message" placeholder="Message" class="form-control border-0 p-4" required></textarea>
                ...
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="feature-text bg-white rounded p-lg-5">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div class="ml-4">
                                <h5>Prime Accountant Practices</h5>
